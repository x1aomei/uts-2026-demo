      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
          ...
          <div v-if="isAuthenticated" class="relative">
            ...
            <div v-if="userMenuOpen" @click.outside="userMenuOpen = false" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 z-50">
              <router-link to="/profile" @click="userMenuOpen = false" class="block px-4 py-2 hover:bg-gray-100 text-gray-700">Profile</router-link>
              <router-link to="/admin" v-if="isAdmin" @click="userMenuOpen = false" class="block px-4 py-2 hover:bg-gray-100 text-gray-700">Admin Panel</router-link>
